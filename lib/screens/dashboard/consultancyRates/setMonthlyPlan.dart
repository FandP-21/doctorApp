...
class SetMonthlyConsultancyPlan extends StatefulWidget {
  SetMonthlyConsultancyPlan({Key key, this.title}) : super(key: key);
  final String title;

  @override
  _SetMonthlyConsultancyPlanState createState() =>
      _SetMonthlyConsultancyPlanState();
}

class _SetMonthlyConsultancyPlanState extends State<SetMonthlyConsultancyPlan> {
  @override
  void initState() {
    super.initState();
  }
                      ...
                      children: <Widget>[
                        Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 15),
                            HeaderText(title: 'Monthly Plan'),
                            SizedBox(height: 10),
                            SubText(
                                isCenter: false,
                                title: 'View and manage your monthly plan'),
                            SizedBox(height: 38),
                            Container(
                            ...
                            textfield('Total number of sessions per month'),
                            textfield('Price per month'),
                            SizedBox(height: 38),
                          ],
                        ),
                        ButtonBlue(
