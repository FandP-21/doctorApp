...
class SetYearlyConsultancyPlan extends StatefulWidget {
  SetYearlyConsultancyPlan({Key key, this.title}) : super(key: key);
  final String title;

  @override
  _SetYearlyConsultancyPlanState createState() =>
      _SetYearlyConsultancyPlanState();
}

class _SetYearlyConsultancyPlanState extends State<SetYearlyConsultancyPlan> {
  @override
  void initState() {
    super.initState();
  }
                      ...
                      children: <Widget>[
                        Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 15),
                            HeaderText(title: 'Yearly Plan'),
                            SizedBox(height: 10),
                            SubText(
                                isCenter: false,
                                title: 'View and manage your yearly plan'),
                            SizedBox(height: 38),
                            Container(
                            ...
                            textfield('Total number of sessions per year'),
                            textfield('Price per year'),
                            SizedBox(height: 38),
                          ],
                        ),
                        ButtonBlue(
